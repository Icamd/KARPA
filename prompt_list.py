...
prompt_evaluate_h="""Given a question and the associated retrieved knowledge graph reasoning paths (topic entity, relation path, tail entity/entities), you are asked to determine whether the provided paths are sufficient to answer the question (respond with 'Yes' or 'No'). If any of the reasoning paths lead to the correct answer, return all those reasoning paths along with the corresponding answer(s). If the reasoning paths are insufficient or do not lead to the answer(s), explain why.

Q: Who is the coach of the team owned by Steve Bisciotti?
Reasoning Paths: Steve Bisciotti, sports.professional_sports_team.owner_s, Baltimore Ravens
Steve Bisciotti, sports.sports_team_owner.teams_owned, Baltimore Ravens
Steve Bisciotti, organization.organization_founder.organizations_founded, Allegis Group
A: {No}. Based on the given reasoning paths, the coach of the team owned by Steve Bisciotti is not explicitly mentioned. However, it can be inferred that the team owned by Steve Bisciotti is the Baltimore Ravens, a professional sports team. Therefore, additional knowledge about the current coach of the Baltimore Ravens can be used to answer the question.

Q: Rift Valley Province is located in a nation that uses which form of currency?
Reasoning Paths: Rift Valley Province, location.administrative_division.country, Kenya
Rift Valley Province, location.location.geolocation, UnName_Entity
Rift Valley Province, location.location.geolocation -> location.mailing_address.state_province_region, UnName_Entity
Rift Valley Province, location.administrative_division.country -> location.country.currency_used, Kenyan shilling
A: {Yes}. Based on the given reasoning paths, Rift Valley Province uses the Kenyan shilling as its currency. Therefore, the reasoning paths is:
1, {Rift Valley Province, location.administrative_division.country -> location.country.currency_used, Kenyan shilling}.

Q: Who is Tom's wife?
Reasoning Paths: Tom, people.marriage.spouse, Helen
Tom, award.award_nomination.award_nominee, Best paper award
Tom, people.person.profession, Scientist
Tom, people.person.children, Anderson
Tom, people.person.children -> people.person.parents, Helen
Relations: people.person.profession; people.marriage.spouse; people.person.nationality; award.award_nomination.award_nominee; people.person.parents; award.award_nominee.award_nominations; people.person.children;
A: {Yes}. Based on the given reasoning paths, Tom's wife is Helen. Therefore, the reasoning paths is:
1, {Tom, people.marriage.spouse, Helen},
2, {Tom, people.person.children -> people.person.parents, Helen}.

Q: 
"""

prompt_evaluate_h2="""Given a question and the associated retrieved knowledge graph reasoning paths (topic entity, relation path, tail entity/entities), you are asked to determine whether any of the provided tail entities are corresponding answers to the question (respond with 'Yes' or 'No'). If any of the tail entities are the correct answer(s), return all those corresponding answer(s) in the format of {answer_1, answer_2, answer_3, ...}. If none of the tail entities in the reasoning paths are right answer(s) to the question, explain why.

Q: Who is the coach of the team owned by Steve Bisciotti?
Reasoning Paths: Steve Bisciotti, sports.professional_sports_team.owner_s, Baltimore Ravens
Steve Bisciotti, sports.sports_team_owner.teams_owned, Baltimore Ravens
Steve Bisciotti, organization.organization_founder.organizations_founded, Allegis Group
Tail Entities: {Baltimore Ravens, Allegis Group}
A: {No}. Based on the given reasoning paths, the coach of the team owned by Steve Bisciotti is not explicitly mentioned. However, it can be inferred that the team owned by Steve Bisciotti is the Baltimore Ravens, a professional sports team. Therefore, additional knowledge about the current coach of the Baltimore Ravens can be used to answer the question.
...
Rift Valley Province, location.location.geolocation -> location.mailing_address.state_province_region, UnName_Entity
Rift Valley Province, location.administrative_division.country -> location.country.currency_used, Kenyan shilling
Tail Entities: {Kenya, UnName_Entity, Kenyan shilling}
A: {Yes}. Based on the given reasoning paths, Rift Valley Province uses the Kenyan shilling as its currency. Therefore, the right answer from tail entities is:
{Kenyan shilling}.
...
Tom, people.person.children, Anderson
Tom, people.person.children -> people.person.parents, Helen
Tail Entities: {Best paper award, Helen, Scientist, Anderson, Helen}
Relations: people.person.profession; people.marriage.spouse; people.person.nationality; award.award_nomination.award_nominee; people.person.parents; award.award_nominee.award_nominations; people.person.children;
A: {Yes}. Based on the given reasoning paths, Tom's wife is Helen. Therefore, the right answer is:
{Helen}.

Q: 
"""

prompt_evaluate_h3="""Given a question and the associated retrieved knowledge graph reasoning paths (topic entity, relation path, tail entity/entities), choose the corresponding answers from provided tail entities. If any of the tail entities are the correct answer(s), return all those corresponding tail entity (entities) in the format of {answer_1, answer_2, answer_3, ...}. If none of the tail entities in the reasoning paths are right answer(s) to the question, explain why.
...
The correct answer to the question is the Kenyan shilling, as identified in the fourth reasoning path. Therefore, the correct tail entity is:
{Kenyan shilling}.
...
Topic Entity: Tom
Relations: people.person.profession; people.marriage.spouse; people.person.nationality; award.award_nomination.award_nominee; people.person.parents; award.award_nominee.award_nominations; people.person.children;
A: Length 1 reasoning path: Tom's wife in knowledge graph could be reached within a single step by finding Tom's spouse through the provided relation "people.person.spouse_s". Therefore, the length 1 reasoning path is: {people.person.spouse_s}.
